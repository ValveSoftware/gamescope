...
namespace gamescope::WaylandServer
{
    ...
    public:
        ...
        {
            reshade_effect_manager_set_effect(
                path,
                [ this ]( const char *callbackPath )
                { EffectReadyCallback( callbackPath ); } );
        }

        void EnableEffect( ) { reshade_effect_manager_enable_effect( ); }
        ...
        void DisableEffect( ) { reshade_effect_manager_disable_effect( ); }
    };
