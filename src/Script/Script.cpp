...
namespace gamescope
{
    ...
    static ConVar<bool> cv_script_use_local_scripts{ "script_use_local_scripts", false, "Whether or not to use the local scripts (../scripts) as opposed to the ones in /etc/gamescope/scripts" };
