...
static int g_isPreviousSaved = 0;
					...
					if ( event.type == SDL_KEYUP && ( event.key.keysym.mod & KMOD_LGUI ) )
					{
						...
						switch ( key )
						{
							...
							case KEY_S:
								...
								break;
							case KEY_G:
								g_forceRelativeMouse = g_forceRelativeMouse != ForceRelativeMouseMode::FORCE_ON ? ForceRelativeMouseMode::FORCE_ON : ForceRelativeMouseMode::OFF;
								SDL_SetRelativeMouseMode( SDL_TRUE );
